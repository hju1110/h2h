...
<!-- 상품 관련 영역 -->
	...
	<tr><td align="right">좋아요 수 : </td><td>( <%=productInfo.getPi_good() %> )</td></tr>	
	<tr>
	...
	<tr><td align="right" style="font-size:20px;">구매 가격 : <%=realPrice %>원</td></tr>	
	<tr><td colspan="2" align="center">
		<input type="button" value="수정하기" class="smt" onclick="location.href='productUp?piid=<%=productInfo.getPi_id() %>';" />
	</td></tr>	
	</table>
	</form>
</td>
...
<div align="center" ><input type="button" value="목록" onclick="location.href='productList';" ></div><br />
</p>
</div>
</body>
</html>