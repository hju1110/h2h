...
<!-- Custom fonts for this template-->
    <link href="/h2hAdmin/resources/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="/h2hAdmin/resources/css/sb-admin-2.min.css" rel="stylesheet">
<style>
  ...
  <form name="frmSch" >
    <fieldset>	
      ...
      <div>
        ...
        <input type="button" value="전체 후원자 보기" onclick="location.href='donaMemList'" />
      </div>
    </fieldset>
  </form>
  <!-- --------------------------------검색 종료 부분------------------- -->
