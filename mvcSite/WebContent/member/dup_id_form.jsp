...
String msg = "중복 검사할 아이디를 입력하세요.";		//아이디 중복 여부에 따라 보여줄 메시지를 저장할 변수
...
*/	
	...
	try {
		...
		if (rs.next()) {
			isDup = true;
			msg = "<span style='color:blue; font-weight:bold; font-size:13px;'>" + "이미 사용중인 아이디 입니다. </span>";
		} else {
			isDup = false;
			msg = "<span style='color:red; font-weight:bold; font-size:13px;'>" + "사용 가능한 아이디 입니다. </span>";
		}
...
<script>
function trans(id) {			// opener = 열어준 놈 기억하셈 !!
