...
int flidx = Integer.parseInt(request.getParameter("flidx"));	// 앞에서 보낸걸로 받은거고 
String kind = request.getParameter("kind");						
String args = (String)request.getAttribute("args");				// 앞에서 넣은 걸 받은 거 

String action = "freeFormUp";						// '수정'일 경우 서브밋될 경로 
if (kind.equals("del")) 	action = "freeProcDel";	//'삭제'일 경우 서브밋될 경로 		
%>
<style>
