...
// 하나의 상품 정보를 저장할 클래스 
	...
	private String pi_id, pcs_id, pb_id, pi_name, pi_com, pi_img1, pi_img2, pi_img3, pi_desc;
	private String pi_special, pi_isview, pi_date, pi_last;
	private String pcb_name, pcs_name, pb_name;
	// 상품 상세보기 화면에서 사용할 분류와 브랜드명을 저장할 변수 
	private ArrayList<ProductStock> stockList;
	// 한 상품에 속하는 옵션 및 재고량들을 저장할 ArrayList
