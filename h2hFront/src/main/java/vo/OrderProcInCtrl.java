...
public class OrderProcInCtrl {
	private String oi_id, mi_id,pi_id, oi_name, oi_phone,oi_zip,oi_addr1, oi_addr2, oi_memo, oi_invoice, oi_status, oi_date; 
	private int oi_pay, oi_upoint;
	
	public OrderProcInCtrl(String oi_id, String mi_id,String pi_id,  String oi_name, String oi_phone, String oi_zip, String oi_addr1,
			String oi_addr2, String oi_memo, String oi_invoice, String oi_status, String oi_date, int oi_pay,
			int oi_upoint) {
		super();
		this.oi_id = oi_id;
		this.mi_id = mi_id;
