...
<body>
<div class="container">
    <div class="title">봉사요청 완료!</div>
    <div class="message">
        봉사활동 요청이 신청되었습니다.<br>
        '요청한 봉사' 확인은 '마이페이지' 내에서도 확인이 가능합니다.
    </div>
    <div class="button-group">
        <button type="button" class="btn btn-primary btn-lg" onclick="location.href='serviceTotalList';">요청한 봉사</button>
