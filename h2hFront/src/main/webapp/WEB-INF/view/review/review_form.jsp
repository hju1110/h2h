...
<tr>
<th width="15%">작성자</th>
<td width="35%"><input type="text" name="rl_writer" class="form-control" /></td>
</tr>
<tr>
<th width="15%">글제목</th>
<td colspan="3"><input type="text" name="rl_title" size="60" class="form-control" /></td>
<td><p><input type="file" name="rl_file" multiple="multiple" class="form-control-file" /></p></td>
</tr>
<tr>
<th>글내용</th>
<td colspan="4"><textarea name="rl_content" rows="10" cols="65" class="form-control" /></textarea></td>
</tr>
